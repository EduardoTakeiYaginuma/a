...
const columns = [
    ...
    { id: 'score', label: 'SCORE', minWidth: 100, Icon: WarningIcon }, // Nova coluna
...
function CasosTable() {
    ...
    // Função para calcular o score (aqui é um valor aleatório como exemplo)
    const calculateScore = () => {
        return (Math.random() * 100).toFixed(2); // Retorna um número aleatório entre 0 e 100 com 2 casas decimais
    };
                                ...
                                .map((caso) => (
                                    <TableRow hover role="checkbox" tabIndex={-1} key={caso._id}>
                                        {columns.map((column) => {
                                            let value;
                                            if (column.id === 'score') {
                                                value = `${calculateScore()}%`; // Exibindo o score como porcentagem

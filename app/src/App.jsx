  ...
  return (
    <>
      <Routes>
        <Route
          path="/"
          element={<Navigate to="/home" />} // Redireciona diretamente para o /home
        />
        <Route path="/login" element={<Login />} />
        ...
        {/* <Route element={<EstaAutenticado />}> */}
          ...
          {/* Rotas do Agente */}
          <Route path="/homeAluno" element={<HomeAgente />} />
          {/* <Route path="/alunos" element={<ListaAluno />} />
          <Route path="/alunos/:id" element={<DadosAluno />} />
          <Route path="/alunos/criar" element={<CadastroAluno />} />
          <Route path="/casos/:id" element={<Casos />} /> */}
          ...
          <Route path="/professor/tarefas" element={<AdicionarTarefa />} />
        {/* </Route> */}
